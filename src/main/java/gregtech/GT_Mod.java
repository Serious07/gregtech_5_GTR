...
public class GT_Mod implements IGT_Mod {
    ...
    public void onPreLoad(FMLPreInitializationEvent aEvent) {
        ...
        gregtechproxy.mAllowLargeTurbinAutomation = tMainConfig.get(aTextGeneral,"mAllowLargeTurbinAutomation",false).getBoolean(false);
        ...
        for (Materials tMaterial : Materials.values()) {
            if ((tMaterial.mElement != null) && (!tMaterial.mElement.mIsIsotope) && (tMaterial != Materials.Magic) && (tMaterial.getMass() > 0L)) {
                ...
                if (tInput != null) {
                    ...
                    GT_Recipe.GT_Recipe_Map.sReplicatorFakeRecipes.addFakeRecipe(false, null, ISmat0, ISmat1, new FluidStack[]{Materials.UUMatter.getFluid(tMaterial.getMass())}, null, (int) (tMaterial.getMass() * 128L), 32, 0);
